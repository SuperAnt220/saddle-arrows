execute if score $allow_infinity saddlarr.settings matches 0 if data entity @s weapon.components.minecraft:enchantments.levels."minecraft:infinity" run return run tag @s add saddlarr.old_arrow
